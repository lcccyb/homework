RGB = imread('C:\Users\lcccy\Desktop\动物照片.bmp');%读取图片
...
figure,imshow(uint8(YUV)),title('原始YUV图像')
...
99 99 99 99 99 99 99 99;
99 99 99 99 99 99 99 99;
99 99 99 99 99 99 99 99;]; %色度`量化表
...
figure,imshow(YUVI),title('压缩后YUV图像');
...
RGBI = uint8(RGBI);
figure,imshow(RGBI),title('压缩后JPEG图像');
imwrite(RGBI,'C:\Users\lcccy\Desktop\result.jpg'); %保存压缩图像